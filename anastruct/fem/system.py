        ...
        if element_id != 0:
            ...
            if el.type == "truss":
                return {
                    ...
                    "wtotal_max": np.max(el.total_deflection),
                    "wtotal_min": np.min(el.total_deflection),
                    "wtotal": el.total_deflection if verbose else None,
                ...
                return {
                    ...
                    "wtotal_max": np.min(el.total_deflection),
                    "wtotal_min": np.max(el.total_deflection),
                    "wtotal": el.total_deflection if verbose else None,
