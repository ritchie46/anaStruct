...
class SimpleUnitTest(unittest.TestCase):
    ...
    def test_HE100B_EU(self):
        ...
        sectionbase.set_unit_system(lenght_unit='m', mass_unit='kg', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        ...
        sectionbase.set_unit_system(lenght_unit='cm', mass_unit='kg', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        ...
        sectionbase.set_unit_system(lenght_unit='mm', mass_unit='kg', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        ...
        sectionbase.set_unit_system(lenght_unit='ft', mass_unit='kg', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        ...
        sectionbase.set_unit_system(lenght_unit='inch', mass_unit='kg', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        ...
        sectionbase.set_unit_system(lenght_unit='ft', mass_unit='lb', force_unit = 'N')
        param = sectionbase.get_sectionparameters('HE 100 B')
        self.assertAlmostEqual(param['Ax'] / (26e-4 / (0.3048**2)) , 1, places=2)
        ...
        sectionbase.set_unit_system(lenght_unit='ft', mass_unit='lb', force_unit = 'lbf')
        param = sectionbase.get_sectionparameters('HE 100 B')
        self.assertAlmostEqual(param['Ax'] / (26e-4 / (0.3048**2)) , 1, places=2)
        self.assertAlmostEqual(param['mass'] / (20.4*0.3048/0.454)  , 1, places=2)
        self.assertAlmostEqual(param['Iy'] / (449.5e-8 / (0.3048)**4) , 1, places=2)
    ...
    def test_W12X65_US(self):
        ...
        sectionbase.set_databasename('US')
        
        #W12X65 has mass=65[lb/ft] Ax=19.1[inch2] Iy=533[inch4] Iz=174[inch4]

        sectionbase.set_unit_system(lenght_unit='inch', mass_unit='lb', force_unit = 'lbf')
        param = sectionbase.get_sectionparameters('W12X65')
