...
class Element:
    def __init__(self, int id_, double EA, double EI, double l, double ai, vertex_1, vertex_2, spring=None):
        """
...
cdef object[double, ndim=2] kinematic_matrix(double ai, double aj, double l):
    """
...
cdef object[double, ndim=2] constitutive_matrix(double EA, double EI, double l, spring=None):
    """
...
class SystemElements:
    ...
    def __assemble_system_matrix(self):
        ...
        Shape = n * 3
        """
        cdef int shape, matrix_index, i, count
        cdef double K
    ...
    def solve(self, gnl=False, force_linear=False, verbosity=0, int max_iter=1000):
        """
        ...
        """
        cdef int count, k, index_node_1, index_node_2
